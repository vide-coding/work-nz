...
<template>
  <div class="bg-white border border-gray-200 rounded-lg overflow-hidden transition-shadow hover:shadow-md select-none" :class="{ 'border-gray-300': isExpanded }" :data-task-id="task.id">
