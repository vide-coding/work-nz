...
async function deleteProject(project: Project) {
  if (!confirm(locale.value === "zh-CN" ? "确定删除此项目吗？" : "Are you sure you want to delete this project?")) {
    return;
  }
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <div class="flex-1 flex flex-col overflow-hidden">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                :class="sortBy === 'updatedAt' ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'"
              ...
              <button
                class="flex items-center gap-1 px-3 py-2 text-sm rounded-lg transition-colors"
                :class="sortBy === 'name' ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'"
            ...
            <button
              ...
              :class="showPreview ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'"
        ...
        <div class="flex-1 overflow-auto p-6">
          <div v-if="loading && projects.length === 0" class="flex items-center justify-center h-full">
            <Loader2 class="w-8 h-8 text-indigo-600 animate-spin" />
          </div>

          <div v-else-if="filteredProjects.length === 0" class="flex flex-col items-center justify-center h-full text-gray-500 dark:text-gray-400">
          ...
          <div v-else class="grid gap-4">
            <div
              ...
              :class="selectedProject?.id === project.id ? 'border-indigo-500 ring-2 ring-indigo-500/20' : 'border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600'"
                ...
                <div class="flex items-start justify-between">
                  <div class="flex items-start gap-3">
                    <div
                      ...
                      :style="{ backgroundColor: project.display?.themeColor || '#4F46E5' }"
                    >
        ...
        <div class="p-6">
          ...
          <div class="text-center mb-6">
            <div
              ...
              :style="{ backgroundColor: selectedProject.display?.themeColor || '#4F46E5' }"
            >
